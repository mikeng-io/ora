...
def _load_dotenv(path: Path) -> None:
    ...
    for line in path.read_text().splitlines():
        ...
        # Strip surrounding quotes: a pasted `KEY="sk-..."` otherwise carries
        # the quote characters into the value, and the failure surfaces far
        # away as an opaque 401 from whichever service got the mangled key.
